<h1 align="center"> WEB BASED MULTIDEVICE QR </h1>
  ...
  <html>
   <body>
  <p align="center">  
  <a aria-label="FORK" href="https://github.com/Venocybertech/Lennie-qr/fork" target="_blank">
    <img alt="License: GPL-3" src="https://img.shields.io/github/stars/SuhailTechInfo/web-qr?style=social" target="_blank" />
  </a>
  <a aria-label="Lennie_W is free to use" href="https://www.youtube.com/@lenniestic_arts" target="_blank">
...
## Deployment Methods
---
1.  ***Click [`FORK`](https://github.com/Venocybertech/Lennie-qr/fork) and `Star ⭐ Repository` if you get help from repo.***
2.  ***Deploy on [`HEROKU`](https://dashboard.heroku.com/new?template=https://github.com/Venocybertech/Lennie-qr).***
3.  ***Deploy on [`REPLIT`](https://replit.com/github/Venocybertech/Lennie-qr).***
...
[![Venocyber tech](https://readme-typing-svg.demolab.com?font=Anton&size=30&pause=998&color=F51FFF&background=F7F2F20A&vCenter=true&random=false&width=465&lines=Hello+Everyone%F0%9F%91%8B!;thank+you+for+visiting+my+site;I+am+venocyber+admin+founder+of+this+project;together+with+Lennie;and+creator+too;i'm+looking+forwad+for+your+feedback;love+you+💖+🫂+💕+😕🙃+😉)](https://github.com/Kingjux)
